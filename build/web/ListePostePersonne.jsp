...
<body>
    ...
    <div class="container-fluid my-5">
            ...
            <div class="row justify-content-center w-100">
                <div class="col-md-12">
                    <h3>Liste des employes et ses postes</h3>
                    
                        <% 
                            HistoriquePoste appelHisto = new HistoriquePoste();
                            appelHisto.MettreAJourTousLesEmployers();
                            V_PostePersonne appel = new V_PostePersonne();
                            List<V_PostePersonne> ListePoste = appel.SelectV_PostePersonne();
                        %>
                        ...
                        <table border="1px">
                            ...
                            <% for(int i = 0 ; i < ListePoste.size() ; i++){ %>
                                <tr>
                                    <td><%= ListePoste.get(i).getNomPersonne() %></td>
                                    <td><%= ListePoste.get(i).getAnciennete() %></td>
                                    <td><%= ListePoste.get(i).getNomPersonnel() %></td>
                                    <td><%= ListePoste.get(i).getTauxHoraire() %></td>
                                </tr>
                            <%}%>
                        </table>
