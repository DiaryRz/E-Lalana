...
<body>
    ...
    <div class="container-fluid my-5">
            ...
            <div class="row justify-content-center w-100">
                <div class="col-md-12">
                    <h3>Pourcentage</h3>
                    <form action="pourcentage.jsp" method="post" class="question-form w-100">
                        <div class="mb-3">
                            <select type="text" name="idproduit" class="form-control" placeholder="Produit">
                                <%for(int i = 0 ; i < route.size() ; i++){%>
                                    <option value="0">Tous</option>
                                    <option value="<%= route.get(i).getIdRoute()%>"><%= route.get(i).getNomRoute()%></option>
                                <%}%>
                            </select>
                        </div>
                        <div class="mb-3">
                            <select type="text" name="taille" class="form-control" placeholder="Taille">
                                <option value="0">Tous</option>
