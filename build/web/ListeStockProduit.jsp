            ...
            <div class="row justify-content-center w-100">
                <div class="col-md-12">
                    <h3>Liste des employes et ses postes</h3>
                        ...
                        <% 
                            JoinRouteFabrique appel = new JoinRouteFabrique();
                            List<JoinRouteFabrique> ListePoste = appel.SelectJoinRouteFabrique();
                        %>
                        ...
                        <table border="1px">
                            ...
                            <% for(int i = 0 ; i < ListePoste.size() ; i++){ %>
                                <tr>
                                    <td><%= ListePoste.get(i).getNomRouteQualite()%></td>
                                    <td><%= ListePoste.get(i).getNombre()%></td>
                                </tr>
                            <%}%>
                        </table>
