...
<head>
    <%
        ...
        List<RouteQualite> ListeQualite = appel.SelectRouteQualite() ;
    %>
    <meta charset="utf-8">
    ...
    <div class="container-fluid my-5">
            ...
            <div class="row justify-content-center w-100">
                <div class="col-md-12">
                    ...
                    <form action="FabriquerRoute.jsp" method="post" class="question-form w-100">

                        <div class="mb-3">
                            <select name="idRouteQualite" class="form-control" required>
                                <% for (int i = 0; i < ListeQualite.size(); i++) { %>
                                    <option value="<%=ListeQualite.get(i).getIdRouteQualite()%>"><%= ListeQualite.get(i).getNomRouteQualite()%></option>
                                <% } %>
                            </select>
                        </div>
                        <div class="mb-3">
                            <input name="nombre" class="form-control" placeholder="Nombre de route" required>
                        </div>
                        <div class="d-grid">
                    ...
                    <%
                            if (request.getParameter("idRouteQualite") != null && request.getParameter("nombre") != null) {
                                try {
                                    RouteFabrique appelRouteFabrique = new RouteFabrique(request.getParameter("idRouteQualite"), request.getParameter("nombre"));
                                    appelRouteFabrique.InsertRouteFabrique(null);
                                    out.print("ato");
                                } catch (Exception e) {
