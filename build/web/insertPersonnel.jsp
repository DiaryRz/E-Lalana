...
<body>
    ...
    <div class="container-fluid my-5">
            ...
            <div class="row justify-content-center w-100">
                <div class="col-md-12">
                    <h3>Inserer type de Personnel</h3>
                    <form action="insertPersonnel.jsp" method="post" class="question-form w-100">
                        <div>
                            <input type="text" name="nomPersonnel" class="form-control" placeholder="Type de personnel">
                        </div>
                        <div>
                            <input type="number" name="expMin" class="form-control" placeholder="experience minimum">
                        </div>
                        <div>
                            <input type="number" name="expMax" class="form-control" placeholder="experience maximums">
                        </div>
                        <div>
                            <input type="number" name="augmentation" class="form-control" placeholder="augmentation">
                        </div>
                        <div>
                    ...
                    <%
                        if( request.getParameter("nomPersonnel") != null && request.getParameter("expMin") != null && request.getParameter("expMax") != null && request.getParameter("augmentation") != null ){
                            Personnel appelPersonnel = new Personnel(request.getParameter("nomPersonnel"),request.getParameter("expMin"),request.getParameter("expMax"),request.getParameter("augmentation"));
                            appelPersonnel.InsertPersonnel(null);
                        }
                    %>
                </div>
