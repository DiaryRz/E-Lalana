<%-- 
    Document   : index
    Created on : 12 déc. 2023, 14:32:19
    Author     : Diary
--%>

<%@page import="elements.V_MaterielType"%>
<%@page import="java.util.List"%>
<%@page import="elements.Type"%>
...
<body>
        ...
        <div class="row border-top px-xl-5">
            <div class="col-lg-3 d-none d-lg-block">
                ...
                <nav class="collapse show navbar navbar-vertical navbar-light align-items-start p-0 border border-top-0 border-bottom-0" id="navbar-vertical">
                        ...
                        <a href="StockMatiereP.jsp" class="nav-item nav-link">Stock Matiere Premiere</a>
    ...
    <div class="container-fluid my-5">
        <div class="py-5 px-xl-5">
            <div class="form">
                <form action="index.jsp" class="question-control">
            ...
            <div class="tableau">
                <% if(request.getParameter("idType") != null){ %>
                    <%
                        V_MaterielType appel = new V_MaterielType(request.getParameter("idType")) ;
                        List<V_MaterielType> Liste = appel.SelectRepMaterielParType();
                    %>
                    <table class="table table-bordered">
                        ...
                        <% for(int i = 0; i < Liste.size() ; i++) { %>
                            <tr>
                                <td><%= Liste.get(i).getNomType() %></td>
                                <td><%= Liste.get(i).getNomMateriel()%></td>
                            </tr>
                        <%}%>
                    </table>  
