...
<body>
    ...
    <div class="container-fluid my-5">
            ...
            <div class="row justify-content-center w-100">
                <div class="col-md-12">
                    <h3>Liste des stock de Matières Premières</h3>
                    
                        <% 
                            V_ResteStock appel = new V_ResteStock();
                            List<V_ResteStock> ListePoste = appel.SelectV_ResteStock();
                        %>
                        ...
                        <table border="1px">
                            ...
                            <% for(int i = 0 ; i < ListePoste.size() ; i++){ %>
                                <tr>
                                    <td><%= ListePoste.get(i).getNomMateriel()%></td>
                                    <td><%= ListePoste.get(i).getQuantite()%></td>
                                </tr>
                            <%}%>
                        </table>
