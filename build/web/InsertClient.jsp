...
<body>
    ...
    <div class="container-fluid my-5">
            ...
            <div class="row justify-content-center w-100">
                <div class="col-md-12">
                    <h3>Inserer un employé</h3>
                    <form action="InsertClient.jsp" method="post" class="question-form w-100">
                        <div>
                            <input type="text" name="nomPersonne" class="form-control" placeholder="Nom de la personne">
                        </div>
                        <div>
                            <select name="idPersonnel" lass="form-control">
                        ...
                        <div>
                            <input type="date" name="DTN" class="form-control" placeholder="date de naissance">
                        </div>
                        <div>
                            
                            <input type="number" name="salaire" class="form-control" placeholder="salaire de base">
                        </div>
                        <div>
                          
                            <input type="date" name="dateM" class="form-control" placeholder="date de naissance">
                        </div>    
                    ...
                    <%
                        if( request.getParameter("nomPersonne") != null && request.getParameter("idPersonnel") != null && request.getParameter("dateM") != null && request.getParameter("salaire") != null ){
                            Personne appelPersonne = new Personne(request.getParameter("nomPersonne"),request.getParameter("idPersonnel"),request.getParameter("DTN"),request.getParameter("salaire"),request.getParameter("dateM"));
                            appelPersonne.InsertPersonne(null);
                        }
                    %>
                </div>
