...
<body>
    ...
    <div class="container-fluid my-5">
            ...
            <div class="row justify-content-center w-100">
                <div class="col-md-12">
                    <h3>Filtrer le prix</h3>
                    <form action="FiltreBenefice.jsp" method="post" class="question-form w-100">
                        <div class="mb-3">
                            <input type="number" name="min" class="form-control" placeholder="Prix Minimum">
                        </div>
                        <div class="mb-3">
                            <input type="number" name="max" class="form-control" placeholder="Prix Maximum">
                        </div>
                        ...
                        <% if (request.getParameter("min") != null && request.getParameter("max") != null) {
                                Benefice appel = new Benefice();
                                List<Benefice> ListeFiltre = appel.FiltreBenefice(request.getParameter("min"), request.getParameter("max"));
                        %>
                                ...
                                <table border="1px">
                                    ...
                                    <% for(int i = 0 ; i < ListeFiltre.size() ; i++){ %>
                                        <tr>
                                            <td><%= ListeFiltre.get(i).getNomRouteQualite() %></td>
                                            <td><%= ListeFiltre.get(i).getPrixDeVente() %></td>
                                            <td><%= ListeFiltre.get(i).getPrixRevient() %></td>
                                            <td><%= ListeFiltre.get(i).getBenefice() %></td>
                                        </tr>
                                    <%}%>
                                </table>
                        <%}%>
