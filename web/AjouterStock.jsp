...
<head>
    <%
        Materiel appelMtaeriel = new Materiel();
        List<Materiel> ListeMateriel = appelMtaeriel.SelectMaterielTsotra();
    %>
    <meta charset="utf-8">
...
<body>
    ...
    <div class="container-fluid my-5">
            ...
            <div class="row justify-content-center w-100">
                <div class="col-md-12">
                    <h3>Ajouter aux Stock</h3>
                    <form action="AjouterStock.jsp" method="post" class="question-form w-100">

                        <div class="mb-3">
                            <select name="idMateriel" class="form-control" required>
                                <% for (int i = 0; i < ListeMateriel.size(); i++) { %>
                                    <option value="<%=ListeMateriel.get(i).getIdMateriel() %>"><%= ListeMateriel.get(i).getNomMateriel() %></option>
                                <% } %>
                            </select>
                        </div>
                        <div class="mb-3">
                            <input type="number" name="Nombre" class="form-control" placeholder="Nombre de route" required>
                        </div>
                        <div class="d-grid">
                    ...
                    <%
                        if( request.getParameter("idMateriel") != null && request.getParameter("Nombre") != null ){
                            Stock appelStock = new Stock(request.getParameter("idMateriel") , request.getParameter("Nombre")); 
                            appelStock.AjouterStock(null);
                        }
                    %>
                </div>
