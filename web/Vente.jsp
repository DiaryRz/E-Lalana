...
<body>
    ...
    <%
        ...
        List<RouteQualite> ListeRouteQ = appel.SelectRouteQualite();
        Client appelPersonne = new Client();
        List<Client> ListePersonne = appelPersonne.SelectClient();
    %>
    <div class="container-fluid my-5">
            ...
            <div class="row justify-content-center w-100">
                <div class="col-md-12">
                    ...
                    <form action="Vente.jsp" method="post" class="question-form w-100">
                        <div>
                            <select name="idRouteQualite" lass="form-control">
                                <% for(int i = 0 ; i < ListeRouteQ.size() ; i++ ) {%>
                                    <option value="<%= ListeRouteQ.get(i).getIdRouteQualite()%>"> <%= ListeRouteQ.get(i).getNomRouteQualite()%> </option>
                                <%}%>
                            </select>
                        </div>
                        <div>
                            <select name="idClient" lass="form-control">
                                <% for(int i = 0 ; i < ListePersonne.size() ; i++ ) {%>
                                    <option value="<%= ListePersonne.get(i).getIdClient()%>"> <%= ListePersonne.get(i).getNomClient()%> </option>
                                <%}%>
                            </select>
                        </div> 
                    ...
                    <%
                            ...
                            if( request.getParameter("idRouteQualite") != null && request.getParameter("idClient") != null ){
                                try{
                                Vente appelVente = new Vente(request.getParameter("idRouteQualite"),request.getParameter("idClient"));
                                appelVente.InsertVente(null);
                                }catch(Exception e){
