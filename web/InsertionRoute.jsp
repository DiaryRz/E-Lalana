    ...
    <div class="container-fluid my-5">
            ...
            <div class="row justify-content-center w-100">
                <div class="col-md-12">
                    ...
                    <form action="InsertionRoute.jsp" method="post" class="question-form w-100">

                        <div class="mb-3">
                            <input type="text" name="nom" class="form-control" placeholder="Nom de la route" required>
                        </div>
                        <div class="mb-3">
                    ...
                    <%
                        if( request.getParameter("nom") != null && request.getParameter("idType") != null ){

                            Route appelRoute = new Route(request.getParameter("nom"),request.getParameter("idType"));
                            appelRoute.InsertRoute(null);
                        }
                    %>
                </div>
