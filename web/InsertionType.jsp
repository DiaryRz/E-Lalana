...
<body>
    ...
    <div class="container-fluid my-5">
            ...
            <div class="row justify-content-center w-100">
                <div class="col-md-12">
                    <h3>Inserer un type</h3>
                    <form action="InsertionType.jsp" method="post" class="question-form w-100">

                        <div class="mb-3">
                            <input type="text" name="NomType" class="form-control" placeholder="Nom du type" required>
                        </div>
                     ...
                     <% 
                        if (request.getParameter("NomType") != null) {
                                Type appelType = new Type(request.getParameter("NomType"));
                                appelType.InsertType(null);
                            }
                    %>
                </div>
            </div>
