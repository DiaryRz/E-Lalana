...
<head>
    <%
        ...
        List<RouteQualite> ListeRouteQualite = appelRouteQualite.SelectRouteQualite();
    %>
    <meta charset="utf-8">
...
<body>
    ...
    <div class="container-fluid my-5">
            ...
            <div class="row justify-content-center w-100">
                <div class="col-md-12">
                    <h3>Inserer prix de vente</h3>
                    <form action="InsertVente.jsp" method="post" class="question-form w-100">
                        <div class="mb-3">
                            <select name="idRouteQualite" class="form-control" required>
                                <% for (int i = 0; i < ListeRouteQualite.size(); i++) { %>
                                    <option value="<%=ListeRouteQualite.get(i).getIdRouteQualite() %>"><%= ListeRouteQualite.get(i).getNomRouteQualite() %></option>
                                <% } %>
                            </select>
                        </div>
                        <div>
                    ...
                    <%
                        if(request.getParameter("idRouteQualite") != null && request.getParameter("prix")!=null){
                            PrixVente appelPrixVente = new PrixVente(request.getParameter("idRouteQualite"),request.getParameter("prix"));
                            appelPrixVente.InsertPrixVente(null);
                        }
                    %>
                </div>
