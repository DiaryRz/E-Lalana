    ...
    <div class="container-fluid my-5">
            ...
            <div class="row justify-content-center w-100">
                <div class="col-md-12">
                    ...
                    <form action="filtrePrix.jsp" method="post" class="question-form w-100">
                        <div class="mb-3">
                        ...
                        <% if (request.getParameter("min") != null && request.getParameter("max") != null) {
                                ...
                                List<V_RouteQualiteMateriel> ListeFiltre = appel.AvoirPrixEntreMinMax(request.getParameter("min"), request.getParameter("max"));
                        %>
                        
                                <table border="1px">
                                    <tr>
                                        <th>Nom de la route</th>
                                        <th>Qualite(taille) de la route</th>
                                        <th>Prix</th>
                                    </tr>
                                    <% for(int i = 0 ; i < ListeFiltre.size() ; i++){ %>
                                        <tr>
                                            <td><%= ListeFiltre.get(i).getNomRoute() %></td>
                                            <td><%= ListeFiltre.get(i).getNomQualite() %></td>
                                            <td><%= ListeFiltre.get(i).getPrix() %></td>
                                        </tr>
                                    <%}%>
                                </table>
                        <%}%>
