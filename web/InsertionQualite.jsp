...
<head>
    <meta charset="utf-8">
    <title>Insertion de qualite</title>
    ...
    <div class="container-fluid my-5">
            ...
            <div class="row justify-content-center w-100">
                <div class="col-md-12">
                    ...
                    <form action="InsertionQualite.jsp" method="post" class="question-form w-100">

                        <div class="mb-3">
                            <input type="text" name="qualite" class="form-control" placeholder="Nom de la qualite" required>
                        </div>
                        <div class="mb-3">
                            <input type="number" name="longueur" class="form-control" placeholder="Longueur" required>
                        </div>
                        <div class="mb-3">
                            <input type="number" name="largeur" class="form-control" placeholder="Largeur" required>
                        </div>
                        <div class="mb-3">
                        <div class="mb-3">
                            <input type="number" name="niveauqualite" class="form-control" placeholder="Niveau de qualite" required>
                        </div>
                    ...
                    <%
                        if(request.getParameter("qualite") != null && request.getParameter("niveauqualite") != null && request.getParameter("longueur") != null && request.getParameter("largeur") != null){
                            Qualite appelQualite = new Qualite(request.getParameter("qualite"), request.getParameter("longueur"),request.getParameter("largeur"),request.getParameter("niveauqualite"));
                            appelQualite.InsertQualite(null);
                        }
                    %>
                </div>
